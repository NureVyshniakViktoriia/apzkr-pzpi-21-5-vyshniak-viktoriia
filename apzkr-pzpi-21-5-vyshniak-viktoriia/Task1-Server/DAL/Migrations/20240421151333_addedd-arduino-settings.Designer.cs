...
namespace DAL.Migrations
{
    ...
    [Migration("20240421151333_addedd-arduino-settings")]
    partial class addeddarduinosettings
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Domain.Models.ArduinoSettings", b =>
                {
                    ...
                    b.Property<string>("GPSTrackerIpAddress")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("TemperatureMonitorIpAddress")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Domain.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            RegisteredOnUtc = new DateTime(2024, 4, 21, 15, 13, 33, 203, DateTimeKind.Utc).AddTicks(6451),
                            Role = 2
                        });
                });
